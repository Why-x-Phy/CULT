...
const Home = () => {
  const tokenAddress = "0xa77638BD2ccd3350C8a3F507E1Ec4645AF7021A3";
  ...
  const maxClaimable = useMemo(() => {
    ...
    try {
      ...
      bnMaxClaimable = BigNumber.from(100_000_000_000);
    }
    ...
    try {
      ...
      perTransactionClaimable = BigNumber.from(100_000_000_000);
    }
